package com.jgg.refreshview.headerview;
 ...
 * google原生
 */
public class MaterialHeader extends View implements IHeaderCallBack {
    ...
    public MaterialHeader(Context context, int pinnedTime) {
        super(context);
        initView();
