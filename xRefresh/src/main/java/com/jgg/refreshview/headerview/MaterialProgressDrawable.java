...
public class MaterialProgressDrawable extends Drawable implements Animatable {
	...
	private void setUp(final double diameter) {
		final int shadowYOffset = Utils.dip2px(mParent.getContext(),
				Y_OFFSET);
		final int shadowXOffset = Utils.dip2px(mParent.getContext(),
				X_OFFSET);
		int mShadowRadius = Utils.dip2px(mParent.getContext(),
				SHADOW_RADIUS);
