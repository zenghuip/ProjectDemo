...
package com.jgg.games.widget.pickerview.adapter;
...
public class NumericWheelAdapter extends AbstractWheelTextAdapter {
    ...
    public NumericWheelAdapter(Context context, int minValue, int maxValue, String format, String unit, int doubleNum) {
        super(context);
        this.minValue = minValue;
        this.maxValue = maxValue;
        this.format = format;
