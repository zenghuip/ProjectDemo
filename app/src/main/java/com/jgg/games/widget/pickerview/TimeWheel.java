...
import com.jgg.games.widget.pickerview.adapter.NumericWheelAdapter;
import com.jgg.games.widget.pickerview.config.PickerConfig;
import com.jgg.games.widget.pickerview.data.TimeRepository;
import com.jgg.games.widget.pickerview.utils.PickerContants;
import com.jgg.games.widget.pickerview.utils.Utils;
...
public class TimeWheel {
    ...
    void initMinute() {
        ...
        int m = mRepository.getDefaultCalendar().minute;
        int curIndex = m/mPickerConfig.minuteDoubleNum;

        minute.setCurrentItem(curIndex - minMinute);
    ...
    void updateMinutes() {
        ...
        mMinuteAdapter = new NumericWheelAdapter(mContext, minMinute, maxMinute, PickerContants.FORMAT, mPickerConfig.mMinute,mPickerConfig.minuteDoubleNum);
    ...
    public int getCurrentMinute() {
        ...
        return minute.getCurrentItem()*mPickerConfig.minuteDoubleNum + mRepository.getMinMinute(curYear, curMonth, curDay, curHour);
    }
