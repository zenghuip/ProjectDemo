...
package com.jgg.games.widget.pickerview.wheel;
...
import com.jgg.games.widget.pickerview.adapter.WheelViewAdapter;
import com.jgg.games.widget.pickerview.config.DefaultConfig;
...
public class WheelView extends View {
    ...
    int defaultColor, selectorColor,defaultSize,selectorSize;
    // Wheel Values
...
//        mPaintLineRight.setStrokeWidth(context.getResources().getDimensionPixelSize(R.dimen.picker_line_width));
        ...
        defaultSize = DefaultConfig.DEFAULT_SIZE;
        selectorSize = DefaultConfig.SELECT_SIZE;

    }

    public void setConfig(PickerConfig config) {
        mPaintLineCenter.setColor(config.mLineColor);
        ...
        defaultSize = config.mWheelTVNormalSize;
        selectorSize = config.mWheelTVSelectorSize;
    }
