...
public class IntentUtils {
     ...
     * @param value
     */
    public static void intentParam(Context context, Class<?> cls, String key, String value) {
        intentParam(context, cls, new String[]{key}, new String[]{value});
    }
     ...
     * @param values
     */
    public static void intentParam(Context context, Class<?> cls, String[] keys, String[] values) {
        Intent intent = new Intent();
        intent.setClass(context, cls);
