...
public class AppConfig {
	...
	public static String NET_ADDRESS = "http://114.112.106.129/api/graphql/";// 正式地址
    ...
    public static void setDeBugModel(boolean debug) {
		...
		if (debug) {
            ...
            NET_ADDRESS = "http://114.112.106.129/api/graphql/";
			TIEBA_MD5KEY = "2Thf0noU%R&BdD!@aWbzEgqKCyF8OvZl";
            TIEBA_URL = "http://114.112.106.129/discuz.php/";
